...
def index():
    if request.method == 'POST':
                try:
                    ...
                    response = requests.get(f"https://www.google.com/search?q={query}&rlz=1C1NHXL_enIN829IN829&sxsrf=AJOqlzXtgWYz09mRj7lHnUyO9Jo75xXO_A:1677992050954&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjA5IfB_8P9AhXH73MBHb1cBksQ_AUoAnoECAEQBA&biw=1366&bih=625&dpr=1")
